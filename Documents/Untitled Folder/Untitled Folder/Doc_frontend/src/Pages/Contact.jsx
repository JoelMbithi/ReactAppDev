...
const Contact = () => {
  return (
    <div>
      ...
      <div className='my-10 flex flex-col justfy-center md:flex-row gap-10 mb-28 text-sm'>
        <img className='w-full md:max-w-[360px]' src={assets.contact_image} alt='' />

        <div className='flex flex-col justfy-center items-start gap-6'>
          <p className='font-semibold text-lg text-gray-600'>Our OFFICE</p>
          <p className='text-gray-500'>Embakasi<br /> Tel Aviv, Nairobi</p>
